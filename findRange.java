/*
 * GIven a sorted Array [1,3,5,7] find [1,6) find number of values within that range where 1 is
 * inclusive 6 is exclusive. Tiktok In this case, it should return [1, 3, 5]
 */
